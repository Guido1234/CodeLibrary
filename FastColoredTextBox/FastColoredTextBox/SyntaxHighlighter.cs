...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public Style BoldStyle = new TextStyle(null, null, FontStyle.Bold | FontStyle.Underline);
        ...
        {
            BlueBoldStyle = new TextStyle(Brushes.LightBlue, null, FontStyle.Bold);
            BlueStyle = new TextStyle(Brushes.DeepSkyBlue, null, FontStyle.Regular);
            BoldStyle = new TextStyle(null, null, FontStyle.Bold | FontStyle.Underline);
            BrownStyle = new TextStyle(Brushes.LightSeaGreen, null, FontStyle.Italic);
            GrayStyle = new TextStyle(Brushes.LightGray, null, FontStyle.Regular);
            GreenStyle = new TextStyle(Brushes.LightGreen, null, FontStyle.Italic);
            MagentaStyle = new TextStyle(Brushes.LightCoral, null, FontStyle.Regular);
            MaroonStyle = new TextStyle(Brushes.LightGreen, null, FontStyle.Regular);
            RedStyle = new TextStyle(Brushes.Orange, null, FontStyle.Regular);
        }
        ...
        {
            BlueBoldStyle = new TextStyle(Brushes.Blue, null, FontStyle.Bold);
